module.exports = function (app) {
    ...
    app.get('/getBalansByDate/:from_date/:to_date/:selected',courierHistory.getBalansByDate);
    app.get('/getBalansByType/:from_date/:to_date/:selected/:id',courierHistory.getBalansByType);
};